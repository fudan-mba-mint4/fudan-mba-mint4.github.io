...
const CITY_ZH = {
  ...
  'Kaohsiung': '高雄', 'Singapore': '新加坡',
  'Weifang': '潍坊', 'Yantai': '烟台', 'Zibo': '淄博', 'Zhuhai': '珠海',
  'Wenzhou': '温州', 'Quanzhou': '泉州', 'Baotou': '包头', 'Hohhot': '呼和浩特',
  'Nanning': '南宁', 'Guilin': '桂林', 'Sanya': '三亚', 'Haikou': '海口',
  'Lanzhou': '兰州', 'Xining': '西宁', 'Yinchuan': '银川', 'Urumqi': '乌鲁木齐',
  'Lhasa': '拉萨', 'Shijiazhuang': '石家庄', 'Taiyuan': '太原', 'Hefei': '合肥',
  'Luoyang': '洛阳', 'Wuxi': '无锡', 'Changzhou': '常州', 'Nantong': '南通',
  'Yangzhou': '扬州', 'Yancheng': '盐城', 'Jiaxing': '嘉兴', 'Huzhou': '湖州',
  'Shaoxing': '绍兴', 'Jinhua': '金华', 'Taizhou': '台州', 'Lishui': '丽水',
  'Quzhou': '衢州', 'Zhoushan': '舟山', 'Maanshan': '马鞍山', 'Wuhu': '芜湖',
  'Bengbu': '蚌埠', 'Huainan': '淮南', 'Suzhou': '宿州',
  'Jiangchuanlu': '上海·江川路',
  'Pudong': '上海·浦东',
  'Minhang': '上海·闵行',
}
const COUNTRY_ZH = {
  'CN': '中国', 'China': '中国', 'TW': '中国台湾', 'Taiwan': '中国台湾',
  'HK': '中国香港', 'Hong Kong': '中国香港', 'MO': '中国澳门', 'Macau': '中国澳门',
  'US': '美国', 'United States': '美国', 'JP': '日本', 'Japan': '日本',
  'KR': '韩国', 'South Korea': '韩国', 'SG': '新加坡', 'Singapore': '新加坡',
  'GB': '英国', 'United Kingdom': '英国', 'DE': '德国', 'Germany': '德国',
  'FR': '法国', 'France': '法国', 'AU': '澳大利亚', 'Australia': '澳大利亚',
  'CA': '加拿大', 'Canada': '加拿大', 'TH': '泰国', 'Thailand': '泰国',
  'MY': '马来西亚', 'MY': '马来西亚', 'VN': '越南', 'IN': '印度',
}
